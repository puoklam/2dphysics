...
// 	ErrDimsNotMatch = "dimensions not match"
// 	ErrInvalidDims  = "invalid dimensions"
// )
...
// func Rotate(v, o *Vector, a float64) *Vector {
// 	x, y := v.Dims[0]-o.Dims[0], v.Dims[1]-o.Dims[1]
